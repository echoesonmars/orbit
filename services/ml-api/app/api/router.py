...
from app.api.endpoints import predict, data_hub, mission_designer, reports, launches, orbits, scores, forensics, simulator, esg
...
router.include_router(esg.router, prefix="/api/v1", tags=["ESG"])
